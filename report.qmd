...
Fig 4C: Patch-size colour scales are city-specific. Yuexiu and Delft are shown with separate patch-size legends because their green-patch size ranges differ substantially; the colours therefore indicate relative patch size within each city, not a single shared absolute scale.
